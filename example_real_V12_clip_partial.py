...
def main():	
	...
	Act_rotation_of_solid(True,179,180) #rotating the raw data volume = fast==false
	pa_seg.opacity = 0.55	
	SetPlotOptions(pa_seg)

	Act_rotation_of_solid_clockwise(False,180,90)
	...
	Act_rotation_of_solid(True,90,180) #(fast, rangeRotation)
	pa_seg2.opacity = 0.6
